                    ...
                    <form class="space-y-4" action="/login" method="POST">
                        <div>
                            ...
                            <div class="mt-1 relative">
                                <input id="login-email" name="loginEmail" type="email"  class="w-full pl-12 pr-4 py-3 bg-gray-800/50 border border-gray-700 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                <input id="login-password" name="loginPassword" type="password" class="w-full pl-12 pr-4 py-3 bg-gray-800/50 border border-gray-700 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <div class="absolute left-4 top-3.5 text-gray-500">
                    ...
                    <form class="space-y-4" action="/register" method="POST">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="register-firstname" type="text" name="registerFname"  class="mt-1 w-full px-4 py-3 bg-gray-800/50 border border-gray-700 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label for="register-lastname" class="text-sm font-medium text-gray-300">Nom</label>
                                <input id="register-lastname" name="registerLname" type="text"  class="mt-1 w-full px-4 py-3 bg-gray-800/50 border border-gray-700 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                <input id="register-email" name="registerEmail" type="email"  class="w-full pl-12 pr-4 py-3 bg-gray-800/50 border border-gray-700 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <div class="absolute left-4 top-3.5 text-gray-500">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                <input id="register-password" name="registerPassword" type="password"  class="w-full pl-12 pr-4 py-3 bg-gray-800/50 border border-gray-700 text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <div class="absolute left-4 top-3.5 text-gray-500">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                                </div>
                            </div>
